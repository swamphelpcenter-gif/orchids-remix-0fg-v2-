...
export default function TikTokResultClient({ id, data, type }: Props) {
  const mp4Url = `/api/result/mp4tiktok/${id}?type=mp4`;
  ...
  if (!data) {
    return (
      <div className="d-flex flex-column align-items-center justify-content-center vh-100">
        <h1 className="text-danger mb-4">Video Not Found</h1>
        <p className="text-muted mb-4">The requested video could not be found or has expired.</p>
      ...
      <section id="landingHero" className="section-py landing-hero position-relative">
        ...
        <div className="container">
          <div className="hero-text-box text-center">
            <h1 className="text-rainbow-rgb fs-bold hero-title mb-2">TikTok Downloader</h1>
                  ...
                  <div className="card shadow-lg border-0 bg-transparent glass-effect p-4 h-100" style={{ backdropFilter: "blur(10px)", background: "rgba(255,255,255,0.1)" }}>
                    <div className="card-body d-flex flex-column">
                      ...
                      <div className="ratio ratio-9x16 mb-4 bg-black rounded overflow-hidden">
                        <video controls className="w-100 h-100" src={mp4Url} poster={data.thumbnail_url || undefined}>

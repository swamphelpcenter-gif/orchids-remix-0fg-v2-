...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const result = await callGrok(prompt, conversationHistory);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = await callGrok(prompt, history);

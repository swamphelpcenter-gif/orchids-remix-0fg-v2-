  ...
  if (success) {
    return (
      <div className="min-vh-100 d-flex align-items-center justify-content-center" 
        style={{ background: theme === "dark" ? "#0f172a" : "#f8fafc", fontFamily: "'Space Grotesk', sans-serif" }}>
        <div className="card border-0 shadow-lg text-center" style={{ 
          maxWidth: "440px", width: "90%", borderRadius: "24px",
          background: theme === "dark" ? "rgba(30, 41, 59, 0.7)" : "rgba(255, 255, 255, 0.8)",
          backdropFilter: "blur(16px)"
        }}>
          <div className="card-body p-5">
            <div className="mb-4 d-inline-block p-4 rounded-circle" style={{ background: "rgba(16, 185, 129, 0.1)" }}>
              <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2.5">
                <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" />
                <polyline points="22 4 12 14.01 9 11.01" />
              </svg>
            </div>
            <h3 className="fw-bold mb-3" style={{ color: theme === "dark" ? "#f1f5f9" : "#1e293b" }}>Success!</h3>
            <p className="text-muted mb-5">Please check your email to verify your account and complete registration.</p>
            <a href="/login" className="btn w-100 fw-bold text-white py-3" style={{ 
              borderRadius: "12px", 
  ...
  return (
    <div className="min-vh-100 d-flex align-items-center justify-content-center position-relative overflow-hidden" 
      ...
      <div className="position-absolute" style={{
        ...
        background: "radial-gradient(circle, rgba(29, 146, 241, 0.15) 0%, rgba(29, 146, 241, 0) 70%)",
        borderRadius: "50%", zIndex: 0
      }}></div>
      ...
      <div className="container position-relative" style={{ zIndex: 1, maxWidth: "460px" }}>
        <div className="card border-0 shadow-lg overflow-hidden" 
          ...
          <div className="card-body p-4 p-md-5">
            <div className="text-center mb-5">
              ...
              <h3 className="fw-bold mb-1" style={{ color: theme === "dark" ? "#f1f5f9" : "#1e293b" }}>Create Account</h3>
              <p className="text-muted small">Join us and start your journey today</p>
            </div>
            ...
            <form onSubmit={handleRegister}>
                ...
                {password && (
                  <div className="mt-2 px-1">
                    <div className="progress" style={{ height: "4px", background: "rgba(0,0,0,0.05)" }}>
                      <div className="progress-bar" style={{ width: strength.width, backgroundColor: strength.color, transition: "all 0.4s ease" }} />
                    </div>
                    <div className="d-flex justify-content-between mt-1">
                      <small className="fw-bold" style={{ color: strength.color, fontSize: "0.75rem" }}>{strength.text}</small>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="mb-4">
                <label className="form-label small fw-bold mb-2" style={{ color: theme === "dark" ? "#94a3b8" : "#64748b" }}>Confirm Password</label>
                <div className="input-group">
                  <span className="input-group-text border-0" style={{ background: theme === "dark" ? "#1e293b" : "#f1f5f9", borderRadius: "12px 0 0 12px" }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#64748b" strokeWidth="2"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="18" y1="8" x2="18" y2="14"/><line x1="21" y1="11" x2="15" y2="11"/></svg>
                  </span>
                  <input
                    type={showPassword ? "text" : "password"}
                    className="form-control border-0"
            ...
            <p className="text-center mt-5 mb-0 small" style={{ color: theme === "dark" ? "#94a3b8" : "#64748b" }}>
              ...
              <a href="/login" className="fw-bold text-decoration-none" style={{ color: "#4361EE" }}>
                Sign In
              </a>
            </p>
          </div>

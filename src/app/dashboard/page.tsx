...
export default function DocsPage() {
    ...
    useEffect(() => {
      ...
      const identifyDevice = (userAgent: string, info?: any) => {
        ...
        if (/fetch/i.test(ua)) return "fetch";
      ...
      const getDeviceIcon = (device: string) => {
        ...
        const detectRequestType = (userAgent: string): string => {
          if (!userAgent) return 'unknown';
          const ua = userAgent.toLowerCase();
          if (/curl/i.test(ua)) return 'curl';
          if (/axios/i.test(ua)) return 'axios';
          if (/python-httpx|python-requests|got\/|node-fetch|undici|java\/|okhttp|apache-http|wget/i.test(ua)) return ua.split('/')[0].split(' ')[0];
      ...
      const fetchUsername = async (userId: string) => {
        ...
        try {
          const { data } = await supabaseClient
            ...
            .eq("id", userId)
            .single();
          return data ? `user${data.user_number}` : "Guest";
        } catch (e) {
          return "Guest";
        }
      };
          ...
          const updateLists = async (data: any, type: "usage" | "error") => {
            ...
            const itemsWithInfo = await Promise.all(
              data.map(async (item: any) => {
                ...
                const device = identifyDevice(item.user_agent, info);
                const requestType = detectRequestType(item.user_agent || '');
                  const country = info?.country?.name || 'Unknown';
                  const timestamp = new Date(item.created_at).toLocaleTimeString("id-ID", { hour: "2-digit", minute: "2-digit", hour12: false }).replace(":", ".");
                  return { ...item, info, username, device, requestType, city: country, timestamp, deviceIcon: getDeviceIcon(device) };
              })
            );
        if (type === "usage") {
          setUsageList(prev => {
            ...
            async (payload) => {
              ...
              if (!info) {
                ...
                if (info) ipCache.current.set(newLog.ip_address, info);
                    ...
                    const username = await fetchUsername(newLog.user_id);
                    const device = identifyDevice(newLog.user_agent || '', info);
                    const requestType = detectRequestType(newLog.user_agent || '');
                    const city = info?.country?.name || 'Unknown';
                  const timestamp = new Date(newLog.created_at).toLocaleTimeString("id-ID", { hour: "2-digit", minute: "2-digit", hour12: false }).replace(":", ".");
                  const logItem = {
                    ...newLog,
            ...
            <ul className="menu-inner py-1">
                  ...
                  <ul className="menu-sub">
                      ...
                      <li className="menu-item">
                        ...
                        <li className="menu-item">
                            ...
                            <li className="menu-item">
                                  <a href="/api/downloader/tiktokdownloader/mp3?tiktokvid_url=https://vm.tiktok.com/ZSHnCTfnocKjS-G1ogy/" target="_blank" className="menu-link">
                              ...
                              <li className="menu-item">
                                  <a href="/api/downloader/tiktokdownloader/mp4?tiktokvid_url=https://vt.tiktok.com/ZS5pcbS54/" target="_blank" className="menu-link">
                                      <div data-i18n="Download TikTok MP4">Download TikTok MP4</div>
                                      <div className="badge bg-label-info fs-tiny rounded-pill ms-auto">MP4</div>
                                  </a>
                              </li>
                              <li className="menu-item">
                                  <a href="/api/downloader/tiktokdownloader?tiktokvid_url=https://vt.tiktok.com/ZS5pcbS54/" target="_blank" className="menu-link">
                                      <div data-i18n="Download TikTok All">Download TikTok All</div>
                                      <div className="badge bg-label-primary fs-tiny rounded-pill ms-auto">MP4/MP3</div>
                                  </a>
                              </li>
                      </ul>
                </li>
              <li className="menu-item">
                  ...
                  <ul className="menu-sub">
                      ...
                      <li className="menu-item">
                            <a href="/api/search/google/image?query=Vallzx Rest API" target="_blank" className="menu-link">
                        ...
                        <li className="menu-item">
                            <a href="/api/search/google?query=Vallzx Rest API&count=10" target="_blank" className="menu-link">
              ...
              <li className="menu-item">
                            ...
                            <li className="menu-item">
                              ...
                              <li className="menu-item">
                                  <a href="/api/ai/gemini-ai?prompt=Halo%20Apa%20Kabar?" target="_blank" className="menu-link">
                                      <svg className="menu-icon me-2" width="18" height="18" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <title>Google Gemini</title>
                                        <clipPath id="gemini-clip-a"><path fill="#fff" d="M0 0h64v64H0z"/></clipPath>
                                        <g clipPath="url(#gemini-clip-a)">
                                          <path fill="url(#gemini-grad-a)" d="M32 64A38.14 38.14 0 0 0 0 32 38.14 38.14 0 0 0 32 0a38.15 38.15 0 0 0 32 32 38.15 38.15 0 0 0-32 32"/>
                                        </g>
                                        <defs>
                                          <linearGradient id="gemini-grad-a" x1="0" x2="4398.72" y1="6400" y2="1945.28" gradientUnits="userSpaceOnUse">
                              ...
                              <li className="menu-item">
                                ...
                                <li className="menu-item">
                                      <a href="/api/ai/grok-4.1-fast?prompt=What%20is%20the%20meaning%20of%20life?" target="_blank" className="menu-link">
                                          <svg className="menu-icon me-2" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            <title>Grok</title>
                                          ...
                                          <div data-i18n="Grok 4.1 Fast API">Grok 4.1 Fast API</div>
                                        <div className="badge bg-label-warning fs-tiny rounded-pill ms-auto">New</div>
                                    </a>
                                </li>
                                    <li className="menu-item">
                                          <a href="/api/ai/deepseek-r1?prompt=Hello" target="_blank" className="menu-link">
                                              <svg className="menu-icon me-2" width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
                                              ...
                                              <div data-i18n="DeepSeek R1">DeepSeek R1</div>
                                            <div className="badge bg-label-warning fs-tiny rounded-pill ms-auto">New</div>
                                        </a>
                                    </li>
                          </ul>
                ...
                <li className="menu-item">
                    ...
                    <ul className="menu-sub">
                      ...
                      <li className="menu-item">
                          <a href="/api/v2/stalker/instagram?username=elonmusk" target="_blank" className="menu-link">
                              <div data-i18n="Instagram 2">Instagram 2</div>
                          </a>
                      </li>
                      <li className="menu-item">
                      ...
                      <li className="menu-item">
                        ...
                        <li className="menu-item">
                            <a href="/api/stalker/tiktok?url=https://www.tiktok.com/@idk213891" target="_blank" className="menu-link">
                                <div data-i18n="TikTok Stalk">TikTok Stalk</div>
                                <div className="badge bg-label-info fs-tiny rounded-pill ms-auto">New</div>
                            </a>
                        </li>
                        <li className="menu-item">
                            <a href="/api/stalker/youtube?url=https://www.youtube.com/@Google" target="_blank" className="menu-link">
                                <div data-i18n="YouTube Stalk">YouTube Stalk</div>
                                <div className="badge bg-label-danger fs-tiny rounded-pill ms-auto">New</div>
                            </a>
                        </li>
                        <li className="menu-item">
                            <a href="/api/stalker/facebook?url=https://www.facebook.com/facebook" target="_blank" className="menu-link">
                                <div data-i18n="Facebook Stalk">Facebook Stalk</div>
                                <div className="badge bg-label-primary fs-tiny rounded-pill ms-auto">New</div>
                            </a>
                        </li>
                      </ul>
                  </li>
                  ...
                  <div className="col-md-12 col-lg-4">
                    <div className="card">
                      <div className="card-body text-nowrap">
                        ...
                        <img src="https://visora-dev-assets-id.assetsvsiddev.workers.dev/small-favicon/favicon-small.png" className="position-absolute bottom-0 end-0 me-5 mb-5" width="83" alt="Vallzx APIs" />
                      </div>
                    </div>
                  ...
                  {usageList.map((item, idx) => (
                    <div key={idx} className="col-12 d-flex justify-content-between align-items-center">
                      <div className="flex-grow-1 me-3" style={{ minWidth: 0 }}>
                        <div className="d-flex align-items-center">
                          <img 
                            src={item.info?.country?.iso_code ? `https://cdn.ipwhois.io/flags/${item.info.country.iso_code.toLowerCase()}.svg` : `https://cdn.ipwhois.io/flags/us.svg`}
                              height="20" width="20" 
                              className="me-2 rounded-circle border border-2 flex-shrink-0"
                              style={{ objectFit: 'cover' }}
                              alt="flag"
                              onError={(e) => { (e.target as HTMLImageElement).src = 'https://cdn.ipwhois.io/flags/us.svg'; }}
                          />
                              <div className="w-100" style={{ minWidth: 0 }}>
                                ...
                                <div className="fs-tiny text-secondary text-truncate d-flex align-items-center gap-1">
                                  {item.city || 'Unknown'} ・ {item.requestType || item.device} ・ {item.timestamp}
                                </div>
                              </div>
                            </div>
                          </div>

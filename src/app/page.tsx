...
function CurlCodeBlock({ label, code }: { label: string; code: string }) {
  ...
  return (
    <div className="col-lg-4 col-sm-6 mb-6">
      <p className="text-theme-adaptive mb-3 fw-medium">{label}</p>
      <div className="gist">
        <div className="gist-file" translate="no">
          <div className="gist-data">
            <div className="file my-2">
              <div className="Box-body p-0 blob-wrapper data type-sh" style={{ overflow: "auto" }}>
                <div className="gist-header d-flex justify-content-between align-items-center px-3 py-2 border-bottom">
                  <span className="gist-file-name">example.sh</span>
                  <button 
                    onClick={copyToClipboard}
                    className="btn-copy-gist"
                  >
                    {copied ? (
                ...
                <table className="highlight tab-size js-file-line-container" data-tab-size="4">
                  <tbody>
                    {lines.map((line, i) => (
                      <tr key={i}>
                        <td className="blob-num js-line-number" data-line-number={i + 1}></td>
                        <td className="blob-code blob-code-inner js-file-line">{line}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <div className="gist-meta">
            <a href="#" style={{ float: "right" }} className="Link--inTextBlock">view raw</a>
            <a href="#" className="Link--inTextBlock">example.sh</a>
            {" hosted with ❤ by "}
            <a className="Link--inTextBlock" href="https://github.com">GitHub</a>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        [data-bs-theme="dark"] .gist .gist-file {
            border-color: #30363d;
        }

        [data-bs-theme="dark"] .gist .gist-data {
            background-color: #0d1117;
            border-bottom-color: #30363d;
        }

        [data-bs-theme="dark"] .gist-header {
            background: #161b22;
            border-bottom-color: #30363d;
        }

        [data-bs-theme="dark"] .gist-file-name {
            color: #8b949e;
        }

        [data-bs-theme="dark"] .btn-copy-gist {
            color: #8b949e;
        }

        [data-bs-theme="dark"] .btn-copy-gist:hover {
            background: #30363d;
            color: #58a6ff;
        }

        [data-bs-theme="dark"] .gist .blob-num {
            color: #8b949e;
            background-color: #0d1117;
            border-right-color: #30363d;
        }

        [data-bs-theme="dark"] .gist .blob-code-inner {
            color: #c9d1d9;
        }

        [data-bs-theme="dark"] .gist .gist-meta {
            background-color: #0d1117;
            color: #8b949e;
            border-top: 1px solid #30363d;
        }

        [data-bs-theme="dark"] .gist .gist-meta a {
            color: #58a6ff;
        }
      ...
      {isSuspicious && !isVerified ? (
        ...
        <>
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                "documentation": "https://apis.visora.my.id/dashboard",
                "provider": {
                  "@type": "Organization",
                  "name": "Vallzx"
                }
          ...
          />
          <link rel="stylesheet" href="https://github.githubassets.com/assets/gist-embed-68783a026c0c.css" />
            ...
            <section id="landingTeam" className="section-py landing-team">
              <div className="container bg-icon-right position-relative">
                ...
                <div className="row gy-lg-5 gy-12 mt-2">
                  <CurlCodeBlock 
                    label="Contoh imagen 3.3 ultimate:" 
                    code='curl -X POST https://apis.visora.my.id/api/ai/imagen-3.3-ultimate -d "prompt=a cute cat"'
                  />
                  <CurlCodeBlock 
                    label="Contoh Nano Banana:" 
                    code='curl -X POST https://apis.visora.my.id/api/ai/gemini-nano-banana -d "prompt=hello"'
                  />
                    <CurlCodeBlock 
                      label="Contoh ChatGPT:" 
                      code='curl -X POST https://apis.visora.my.id/api/openai/chatgpt -d "prompt=how are you?"'
                    />
                    <CurlCodeBlock 
                      label="Contoh Grok 4.1 Fast API (x.ai):" 
                      code='curl -X POST https://apis.visora.my.id/api/ai/grok-4.1-fast -d "prompt=What is the meaning of life?"'
                    />
                </div>
              </div>
            </section>
